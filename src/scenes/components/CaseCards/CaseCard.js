        ...
        <span>
          ...
          <div className="columns">
            <div className="column">
              ...
              <span className="has-text-weight-semibold is-size-6">{perc < 0 ? <i className="fas fa-caret-down"/> : <i className="fas fa-caret-up"/>}{`  ${perc.toFixed(3)}%`}</span><span> than yesterday</span>
            </div>
          </div>
        </span>
      </div>
